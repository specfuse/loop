...
#
"""Shim — re-exports specfuse.loop.loop. Canonical code lives in the package.

This file ships in the scaffold for dogfood (`python .specfuse/scripts/loop.py`)
...
from specfuse.loop import loop as _m  # noqa: E402

# Mirror the package module's public namespace so importlib-loaded shims and
# `from loop import X` back-compat both resolve every symbol.
