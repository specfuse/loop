...
#
"""Shim — re-exports specfuse.loop.gh_backend. Canonical code lives in the package.

This file ships in the scaffold for dogfood (`python .specfuse/scripts/gh_backend.py`)
...
from specfuse.loop import gh_backend as _m  # noqa: E402

# Mirror the package module's public namespace so importlib-loaded shims and
# `from gh_backend import X` back-compat both resolve every symbol.
