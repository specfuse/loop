...
#
"""Shim — re-exports specfuse.loop.lint_plan. Canonical code lives in the package.

This file ships in the scaffold for dogfood (`python .specfuse/scripts/lint_plan.py`)
...
from specfuse.loop import lint_plan as _m  # noqa: E402

# Mirror the package module's public namespace so importlib-loaded shims and
# `from lint_plan import X` back-compat both resolve every symbol.
