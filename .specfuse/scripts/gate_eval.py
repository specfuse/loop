...
#
"""Shim — re-exports specfuse.loop.gate_eval. Canonical code lives in the package.

This file ships in the scaffold for dogfood (`python .specfuse/scripts/gate_eval.py`)
...
from specfuse.loop import gate_eval as _m  # noqa: E402

# Mirror the package module's public namespace so importlib-loaded shims and
# `from gate_eval import X` back-compat both resolve every symbol.
