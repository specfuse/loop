...
#
"""Shim — re-exports specfuse.loop._miniyaml. Canonical code lives in the package.

This file ships in the scaffold for dogfood (`python .specfuse/scripts/_miniyaml.py`)
...
from specfuse.loop import _miniyaml as _m  # noqa: E402

# Mirror the package module's public namespace so importlib-loaded shims and
# `from _miniyaml import X` back-compat both resolve every symbol.
