...
subprocess.CalledProcessError: Command '['git', '-C', '/tmp/claude-501/tmpr8d47gpq', 'commit', '-q', '-m', 'init']' returned non-zero exit status 128.

----------------------------------------------------------------------
Ran 505 tests in 10.746s
...
$ coverage run --source=.specfuse/scripts -m unittest discover -s tests && coverage report --fail-under=90
  ...
  File "/opt/homebrew/Cellar/python@3.14/3.14.3_1/Frameworks/Python.framework/Versions/3.14/lib/python3.14/subprocess.py", line 577, in run
    raise CalledProcessError(retcode, process.args,
                             output=stdout, stderr=stderr)
subprocess.CalledProcessError: Command '['git', '-C', '/tmp/claude-501/tmpfog90zf2', 'commit', '-q', '-m', 'init']' returned non-zero exit status 128.

----------------------------------------------------------------------
Ran 505 tests in 11.698s
