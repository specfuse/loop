...
"effort field defaults should be declared by WU type, not assumed at dispatch time"),
tagged with this gate's ID. Feature-specific observations stay in `RETROSPECTIVE.md`
