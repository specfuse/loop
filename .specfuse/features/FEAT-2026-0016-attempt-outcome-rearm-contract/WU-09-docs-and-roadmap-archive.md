...
grep -nE '^## ' /Users/christian/Specfuse/loop/docs/methodology.md | head -20
...
6. **Symbol-existence + structure checks** before declaring
   ...
   grep -qE 'Per-attempt outcome events' /Users/christian/Specfuse/loop/docs/methodology.md
   grep -qE 'attempt_outcome' /Users/christian/Specfuse/loop/docs/methodology.md

   # b. methodology.md mentions the re-arm frontmatter additions
   grep -qE 're_arm_count' /Users/christian/Specfuse/loop/docs/methodology.md
   grep -qE 're_arm_history' /Users/christian/Specfuse/loop/docs/methodology.md
   grep -qE 'cumulative_cost_usd' /Users/christian/Specfuse/loop/docs/methodology.md
