...
$ coverage run --source=.specfuse/scripts -m unittest discover -s tests && coverage report --fail-under=70
    __import__(name)
    ~~~~~~~~~~^^^^^^
  File "/Users/christian/Specfuse/loop/tests/test_validate_event.py", line 46, in <module>
    _spec.loader.exec_module(ve)  # type: ignore[union-attr]
    ~~~~~~~~~~~~~~~~~~~~~~~~^^^^
  File "/Users/christian/Specfuse/loop/.specfuse/scripts/validate-event.py", line 51, in <module>
    sys.exit(2)
    ~~~~~~~~^^^
SystemExit: 2
