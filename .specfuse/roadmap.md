...
| FEAT-2026-0027 | Self-provisioning driver: auto-sync `.specfuse/` + plugin config on run | active | — | — |
...
**Status: active.** Depends on FEAT-2026-0026 (needs package scaffold data +
