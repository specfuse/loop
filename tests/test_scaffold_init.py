...
_VERSIONED_SEED_TO_TARGET = {
    ...
    "rules/verification-discipline.md": "rules/verification-discipline.md",
    "rules/operator-escalation.md": "rules/operator-escalation.md",
    "rules/human-output.md": "rules/human-output.md",
    "schemas/event.schema.json": "schemas/event.schema.json",
    "schemas/driver-event.schema.json": "schemas/driver-event.schema.json",
    "schemas/events/initiative_created.schema.json": "schemas/events/initiative_created.schema.json",
    "schemas/events/spec_validated.schema.json": "schemas/events/spec_validated.schema.json",
    "schemas/events/spec_issue_resolved.schema.json": "schemas/events/spec_issue_resolved.schema.json",
    "schemas/events/spec_issue_routed.schema.json": "schemas/events/spec_issue_routed.schema.json",
    "VERSION": "VERSION",
